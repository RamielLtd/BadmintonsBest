...
date: "2020-03-24"
description: "This is a beginners guide for the rules of how to play Badminton. We’ll cover all areas including the basic rules, scoring, serving, differences between singles and doubles, common faults and lets. So what are the basic Badminton rules?"
...
This is the basics of scoring, to learn more read our article on [Badminton rules scoring](/blog/badminton-rules-scoring/).
...
<YouTube id="fYbVojKaPac" title="KC Badminton - Forehand serve" />

### Backhand serve

<YouTube id="-Pf5bQU_FKs" title="KC Badminton - Backhand serve" />
...
<BirdsEyeCourt
  ...
  message="After the initial serve the areas highlighted in orange are in for doubles"
  format="doubles"
/>
...
<BirdsEyeCourt
  spacing="normal"
  demonstrate="area-of-play"
  message="After the initial serve the areas highlighted in orange are in for singles"
  format="singles"
/>
...
<YouTube id="2sAb8Vpl_ZA" title="BWF - Faults at the net" />
...
These are the most common faults, for a complete guide on all the faults in Badminton then check out our [Badminton faults](/blog/badminton-faults/) article.
...
<YouTube
  id="sXls9PPr54Q"
  title="Badminton Europe - Shuttle caught on top of net"
/>
...
Lets don’t happen very often but they’re important to know. To learn about all the situations where lets occur see our guide on [Badminton lets](/blog/badminton-lets/).
